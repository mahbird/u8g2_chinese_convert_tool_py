...
1. 下載<a href="https://github.com/olikraus/u8g2/tree/master"u8g2 library</a>

你可以將本python script放到library的tools/font中

或是將tools/font/bdfconv這個目錄放到本python script所在地
